...
export function significancePrompt(input: LongNarrativePromptInput): SectionPrompt {
  return {
    ...
    user: [
      ...
      'Muestra la importancia con datos concretos del Fact Card: fechas, arquitectos, estilo, patrimonio. Evita adjetivos evaluativos genéricos ("majestuoso", "espectacular") si tienes un hecho verificable.',
